...
public class PreviewTrafficHolder extends PreviewScheduleHolder {
    public static PreviewTrafficHolder create(ViewGroup parent, PreviewScheduleAdapter adapter){
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_preview_traffic,parent,false);
        return new PreviewTrafficHolder(adapter,v);
    }

    public PreviewTrafficHolder(ScheduleAdapter adapter, View v) {
        super(adapter, v);
    }
