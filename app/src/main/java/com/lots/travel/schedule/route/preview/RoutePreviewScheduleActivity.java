...
public class RoutePreviewScheduleActivity  extends RxBaseActivity implements View.OnClickListener {
    ...
    public static void toPreview(Activity context, Schedule schedule, EditTopology topology){
        Intent intent = new Intent(context,RoutePreviewScheduleActivity.class);
    ...
    private RoutePreviewHeaderHolder hHeader;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_route_preview_schedule);
        //状态栏
    ...
    private void initData(Intent data,Bundle savedInstanceState){
        ...
        mScheduleAdapter = new PreviewScheduleAdapter(this,mTopology,mDataManager,new RoutePreviewHolderFactory());
    ...
    private void initViews(){
        ...
        rvContent.addItemDecoration(new RoutePreviewTimelineDecoration(this,.5f));
        ...
        //添加头部
        hHeader = RoutePreviewHeaderHolder.create(rvContent,mScheduleAdapter);
        ...
        Single.create(
                new SingleOnSubscribe<String>() {
                    ...
                    public void subscribe(@io.reactivex.annotations.NonNull SingleEmitter<String> e) throws Exception {
                        ...
                        List<SosonaOssClient.Item> failedItems = mOssClient.upload(RoutePreviewScheduleActivity.this,uploadItems,urlMap);
                        ...
                        try{
                            HttpResult<String> result = ServiceGenerator.createService(RoutePreviewScheduleActivity.this, TripService.class)
                                    .saveTripInfo(params)
                                    .blockingGet();
                ...
                .subscribe(new SingleObserver<String>() {
                    ...
                    public void onSuccess(@io.reactivex.annotations.NonNull String aBoolean) {
                        ...
                        Toast.makeText(RoutePreviewScheduleActivity.this,R.string.route_edit_success,Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(RoutePreviewScheduleActivity.this, MainActivity.class);
                    ...
                    public void onError(@io.reactivex.annotations.NonNull Throwable e) {
                        dismissProgressDialog();
                        Toast.makeText(RoutePreviewScheduleActivity.this,e.toString(),Toast.LENGTH_SHORT).show();
                    }
                });
    }
}