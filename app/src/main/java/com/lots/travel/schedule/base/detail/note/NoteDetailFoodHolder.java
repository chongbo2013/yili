...
public class NoteDetailFoodHolder extends NoteDetailHolder implements View.OnClickListener {
    public static NoteDetailFoodHolder create(ViewGroup parent, NoteDetailAdapter adapter){
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_note_detail_food,parent,false);
        return new NoteDetailFoodHolder(adapter,v);
    }
    ...
    public NoteDetailFoodHolder(ScheduleAdapter adapter, View v) {
        super(adapter, v);
    }
