...
public class EditSpotHolder extends EditScheduleHolder implements View.OnClickListener,DescriptionLayout.OnActionListener{

    public static EditSpotHolder create(ViewGroup parent, EditScheduleAdapter adapter){
        View root = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_edit_spot,parent,false);
        return new EditSpotHolder(adapter,root);
    }
    ...
    public EditSpotHolder(EditScheduleAdapter adapter, View v) {
        super(adapter, v);
    }

    @Override
    public void onCreate(View v) {
        setLeftIcon(ContextCompat.getDrawable(mAdapter.getContext(),R.drawable.ico_timeline_spot));
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.tv_name:{
                Spot spot = getSpot();
                if(spot!=null)
                    triggerScanDetails(spot.getViewurl());
                break;
            }
        }
    }
