package com.lots.travel.schedule.note.edit;
...
import com.lots.travel.schedule.note.move.NoteMoveScheduleActivity;
import com.lots.travel.schedule.note.preview.NotePreviewScheduleActivity;
...
public class NoteEditScheduleActivity extends RxBaseActivity implements View.OnClickListener,OnScheduleListener{
    public static final String SCHEDULE = "Schedule";
    public static final String TOPOLOGY = "Topology";

    public static void toEdit(Context context, Schedule schedule){
        Intent intent = new Intent(context,NoteEditScheduleActivity.class);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_note_edit_schedule);
    ...
    private void initData(Intent intent, Bundle savedInstanceState){
        ...
        //如果topology非空，它一定与data manager一致
        //如果其为空，data manager可能存有之前的遗留数据，所以清空。
        if(mTopology==null) {
        ...
        mScheduleAdapter = new EditScheduleAdapter(this,mTopology,mDataManager,new NoteEditHolderFactory());
    ...
    private void initViews(){
        ...
        rvContent.addItemDecoration(new NoteEditTimelineDecoration(this,0.5f));
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.tv_edit:
                NoteMoveScheduleActivity.toMove(this,REQ_EDIT_COMPONENTS,mDataManager.getSchedule(),mTopology);
                break;

            case R.id.btn_preview:
                NotePreviewScheduleActivity.toPreview(this,mDataManager.getSchedule(),mTopology);
                break;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode){
            ...
            case REQ_EDIT_COMPONENTS:{
                MoveTopology srcTopology = data.getParcelableExtra(NoteMoveScheduleActivity.OUTPUT_TOPOLOGY);
    ...
    public void onAddComponents(int pos) {
        ...
        Long id = mScheduleAdapter.getDstId();
        if(itemType== Topology.TYPE_STAY){
            ChooseStaysActivity.toChoose(this,REQ_ADD_STAY,id);
        }else{
            ChooseComponentsActivity.toChoose(this,REQ_ADD_COMPONENTS,id);
        }
    }
    ...
    /**
     * 1、重新创建TripPart
     * 2、根据tripSoundLen来判断是否有语音文件
     * 3、images是uri不是file路径，所以将其转为file
     */
        ...
        Single.create(
                new SingleOnSubscribe<String>() {
                    ...
                    public void subscribe(@io.reactivex.annotations.NonNull SingleEmitter<String> e) throws Exception {
                        ...
                        List<SosonaOssClient.Item> failedItems = mOssClient.upload(NoteEditScheduleActivity.this,uploadItems,urlMap);
                        ...
                        try{
                            HttpResult<String> result = ServiceGenerator.createService(NoteEditScheduleActivity.this, TripService.class)
                                    .saveTripInfo(params)
                                    .blockingGet();
                ...
                .subscribe(new SingleObserver<String>() {
                    ...
                    public void onSuccess(@io.reactivex.annotations.NonNull String aBoolean) {
                        ...
                        Toast.makeText(NoteEditScheduleActivity.this,R.string.note_edit_success,Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(NoteEditScheduleActivity.this, MainActivity.class);
                    ...
                    public void onError(@io.reactivex.annotations.NonNull Throwable e) {
                        dismissProgressDialog();
                        Toast.makeText(NoteEditScheduleActivity.this,e.toString(),Toast.LENGTH_SHORT).show();
                    }
                });
    }
