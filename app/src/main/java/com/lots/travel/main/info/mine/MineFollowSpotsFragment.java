...
import com.lots.travel.main.info.mine.adapter.MineFollowSpotsAdapter;
...
public class MineFollowSpotsFragment extends PagedItemFragment<FollowPlace> {
        ...
        return new PageIterator.PageRequest<FollowPlace>() {
            ...
            public Single<HttpResult<List<FollowPlace>>> execute(int page) {
                return ServiceGenerator.createService(getContext(), CommonService.class)
                        .getFollowPlaces(new GetFollowPlaces(1,10,GetFollowPlaces.VIEW_TYPE_SPOT));
            }
        };
    }
    ...
    public AbstractLoadAdapter<FollowPlace> createAdapter(RecyclerView rv) {
        return new MineFollowSpotsAdapter(getContext(),rv);
    }
