...
public class NoteDetailTrafficHolder extends NoteDetailHolder {
    public static NoteDetailTrafficHolder create(ViewGroup parent, NoteDetailAdapter adapter){
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_note_detail_traffic,parent,false);
        return new NoteDetailTrafficHolder(adapter,v);
    }

    public NoteDetailTrafficHolder(ScheduleAdapter adapter, View v) {
        super(adapter, v);
    }
