...
public class NotePreviewHeaderHolder extends PreviewScheduleHolder {

    public static NotePreviewHeaderHolder create(ViewGroup parent, PreviewScheduleAdapter adapter){
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_preview_head,parent,false);
        return new NotePreviewHeaderHolder(adapter,v);
    }
    ...
    public NotePreviewHeaderHolder(ScheduleAdapter adapter, View v) {
        super(adapter, v);
    }
