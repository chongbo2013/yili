...
import com.lots.travel.schedule.base.detail.route.RouteDetailTopology;

/**
 * Created by nalanzi on 2018/1/15.
 */

public class RouteDetailFragment extends BaseDetailFragment {
    ...
    public void onDataLoaded(RecyclerView rv, Schedule schedule, DataManager dataManager) {
        Topology topology = RouteDetailTopology.create(dataManager);
        RouteDetailAdapter adapter = new RouteDetailAdapter(getActivity(),topology,dataManager,new RouteDetailHolderFactory());
        rv.setLayoutManager(new LinearLayoutManager(getContext()));
        rv.addItemDecoration(new RouteDetailTimelineDecoration(getContext(),.5f));
        ...
        rv.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                if(mOnScrollChangedListener!=null)
                    mOnScrollChangedListener.onScrollChanged(RouteDetailFragment.this.getClass(),currentGroup,isFooterVisible());
            }
        });
    }
