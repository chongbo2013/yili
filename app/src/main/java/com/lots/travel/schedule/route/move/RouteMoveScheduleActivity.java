...
public class RouteMoveScheduleActivity extends BaseActivity implements View.OnClickListener,OnScheduleListener {
    ...
    public static void toMove(Activity context, int requestCode, Schedule schedule, EditTopology topology){
        Intent intent = new Intent(context,RouteMoveScheduleActivity.class);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_route_move_schedule);
    ...
    private void initData(Intent data,Bundle savedInstanceState){
        ...
        mScheduleAdapter = new MoveScheduleAdapter(this,mTopology,mDataManager,new RouteMoveHolderFactory());
    ...
    private void initViews(){
        ...
        rvContent.addItemDecoration(new RouteMoveTimelineDecoration(this,0.5f));

        ItemTouchHelper touchHelper = new ItemTouchHelper(new RouteMoveItemsCallback(mScheduleAdapter));
