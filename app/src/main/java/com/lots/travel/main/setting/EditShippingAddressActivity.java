...
public class EditShippingAddressActivity extends RxBaseActivity implements View.OnClickListener {
    public static final String SHIPPING_ADDRESS = "ShippingAddress";

    public static void toEdit(Activity context,int requestCode,ShippingAddress shippingAddress){
    ...
    private void initArgs(Intent data, Bundle savedInstanceState){
        mShippingAddress = data.getParcelableExtra(SHIPPING_ADDRESS);
                ...
                ServiceGenerator.createService(this, CommonService.class)
                        ...
                        .subscribe(new SingleAdapter<HttpResult<SaveShipping>>() {
                            ...
                            public void onSuccess(@NonNull HttpResult<SaveShipping> result) {
                                Toast.makeText(EditShippingAddressActivity.this,R.string.shipping_edit_success,Toast.LENGTH_SHORT).show();
                                back(true);
                            }

                            @Override
                            public void onError(Throwable e) {
                                new DefaultExceptionHandler().handleException(EditShippingAddressActivity.this,e);
                            }
                        });
                break;
        }
