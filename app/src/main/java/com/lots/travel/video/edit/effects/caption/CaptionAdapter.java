...
public class CaptionAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        Glide.with(mContext).load(iconPath).into(new ViewTarget<CircularImageView,Drawable>(captionViewHolder.mImage) {
            @Override
            public void onResourceReady(Drawable resource, Transition<? super Drawable> transition) {
                captionViewHolder.mImage.setImageBitmap(((BitmapDrawable) resource).getBitmap());
            }
        });
