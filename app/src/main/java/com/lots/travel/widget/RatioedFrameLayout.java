 ...
 */
//宽高按比率的FrameLayout
public class RatioedFrameLayout extends FrameLayout {
    private float mRatio = 0;

    public RatioedFrameLayout(Context context) {
        this(context,null);
    }

    public RatioedFrameLayout(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
