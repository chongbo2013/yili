...
public class NoteDetailHotelHolder extends NoteDetailHolder implements View.OnClickListener {

    public static NoteDetailHotelHolder create(ViewGroup parent, NoteDetailAdapter adapter){
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_note_detail_hotel,parent,false);
        return new NoteDetailHotelHolder(adapter,v);
    }
    ...
    public NoteDetailHotelHolder(ScheduleAdapter adapter, View v) {
        super(adapter, v);
    }
