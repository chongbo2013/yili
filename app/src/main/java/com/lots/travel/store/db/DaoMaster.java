...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(Database db, boolean ifNotExists) {
        ...
        HttpInterfaceDao.createTable(db, ifNotExists);
        SpotDao.createTable(db, ifNotExists);
        TripPartDao.createTable(db, ifNotExists);
        ViewCityDao.createTable(db, ifNotExists);
    }
    ...
    public static void dropAllTables(Database db, boolean ifExists) {
        ...
        HttpInterfaceDao.dropTable(db, ifExists);
        SpotDao.dropTable(db, ifExists);
        TripPartDao.dropTable(db, ifExists);
        ViewCityDao.dropTable(db, ifExists);
    }
    ...
    public DaoMaster(Database db) {
        ...
        registerDaoClass(HttpInterfaceDao.class);
        registerDaoClass(SpotDao.class);
        registerDaoClass(TripPartDao.class);
        registerDaoClass(ViewCityDao.class);
    }
