...
package com.lots.travel.video.record;
...
public class AliyunVideoRecorder extends Activity implements View.OnClickListener, View.OnTouchListener, ScaleGestureDetector.OnScaleGestureListener, GestureDetector.OnGestureListener {
    ...
    public static void startRecord(Activity context,int requestCode,AliyunSnapVideoParam param){
...
//        EncoderDebugger debugger = EncoderDebugger.debug(this, 528, 704);
    ...
    private void getData() {
        ...
        maxVideoDuration = getIntent().getIntExtra(AliyunSnapVideoParam.MAX_VIDEO_DURATION,30000);
...
//                toSourceType();
            ...
            data.putExtra(RequestRecordActivity.EXTRA_TO_IMPORT,true);
    ...
    private void toEditor() {
        ...
        data.putExtra(EditorActivity.KEY_PROJECT_JSON_PATH, projectUri.getPath());
        data.putStringArrayListExtra(EditorActivity.KEY_TEMP_FILE_LIST, (ArrayList<String>) tempFileList);
        setResult(Activity.RESULT_OK,data);
        finish();
    }

    private void startRecording() {
        String videoPath = new FileStore().getCacheVideoDir() + File.separator + "temp_" + System.currentTimeMillis() + ".mp4";
