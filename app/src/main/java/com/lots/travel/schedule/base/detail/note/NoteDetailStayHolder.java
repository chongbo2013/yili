...
public class NoteDetailStayHolder extends NoteDetailHolder implements View.OnClickListener {
    public static NoteDetailStayHolder create(ViewGroup parent, NoteDetailAdapter adapter){
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_note_detail_stay,parent,false);
        return new NoteDetailStayHolder(adapter,v);
    }
    ...
    public NoteDetailStayHolder(ScheduleAdapter adapter, View v) {
        super(adapter, v);
    }
    ...
    public void onBind() {
        ...
        tripDisplay.setVoice(((NoteDetailAdapter)mAdapter).getPortraitUrl(), TypeUtil.str2int(part.getTripSoundLen()));
