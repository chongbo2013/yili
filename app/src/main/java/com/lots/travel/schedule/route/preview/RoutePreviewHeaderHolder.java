...
public class RoutePreviewHeaderHolder extends PreviewScheduleHolder {

    public static RoutePreviewHeaderHolder create(ViewGroup parent, PreviewScheduleAdapter adapter){
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_preview_head,parent,false);
        return new RoutePreviewHeaderHolder(adapter,v);
    }
    ...
    public RoutePreviewHeaderHolder(ScheduleAdapter adapter, View v) {
        super(adapter, v);
    }
