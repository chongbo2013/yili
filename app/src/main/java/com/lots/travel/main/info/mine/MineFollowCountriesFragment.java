...
import com.lots.travel.main.info.mine.adapter.MineFollowCountriesAdapter;
...
public class MineFollowCountriesFragment extends PagedItemFragment<FollowPlace> {
        ...
        return new PageIterator.PageRequest<FollowPlace>() {
            ...
            public Single<HttpResult<List<FollowPlace>>> execute(int page) {
                return ServiceGenerator.createService(getContext(), CommonService.class)
                        .getFollowPlaces(new GetFollowPlaces(1,10,GetFollowPlaces.VIEW_TYPE_COUNTRY));
            }
        };
    }
    ...
    public AbstractLoadAdapter<FollowPlace> createAdapter(RecyclerView rv) {
        return new MineFollowCountriesAdapter(getContext(),rv);
    }
