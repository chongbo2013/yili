...
public class PreviewSpotHolder extends PreviewScheduleHolder implements View.OnClickListener {
    public static PreviewSpotHolder create(ViewGroup parent, PreviewScheduleAdapter adapter){
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_preview_spot,parent,false);
        return new PreviewSpotHolder(adapter,v);
    }
    ...
    public PreviewSpotHolder(ScheduleAdapter adapter, View v) {
        super(adapter, v);
    }
