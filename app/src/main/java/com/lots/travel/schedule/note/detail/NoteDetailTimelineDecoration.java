...
public class NoteDetailTimelineDecoration extends RecyclerView.ItemDecoration {
    private int dp4,dp10,dp50,dp25;
    private int timeline;
    private Paint linePaint;

    public NoteDetailTimelineDecoration(Context context, float lineWidth){
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView rv, RecyclerView.State state) {
        ...
        NoteDetailAdapter adapter = (NoteDetailAdapter) rv.getAdapter();
